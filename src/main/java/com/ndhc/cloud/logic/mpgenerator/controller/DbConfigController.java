...
public ResultModel findTableInfo(@RequestBody DbConfig dbConfig){
  ...
  public ResultModel generateCode(@RequestBody DbConfig userConfig,HttpServletResponse response) throws  IOException{
      ...
      response.addHeader("Content-Disposition", "attachment;filename="+new String(userConfig.getPackageName().getBytes("utf-8"), "iso8859-1")+".xls");
