package ndhc.cloud.logic.mpgenerator.service.impl;
...
import ndhc.cloud.logic.mpgenerator.util.DBUtil;
import ndhc.cloud.logic.mpgenerator.util.JsonUtil;
import ndhc.cloud.logic.mpgenerator.util.MapUtil;
import ndhc.cloud.logic.mpgenerator.util.MpGenerator;
        ...
        for (UserConfig userConfig : userConfigList) {
           ...
           try {
              ...
              dbConfig.setDbType(dbType);
               ...
               dbConfig= DBUtil.driverType(dbConfig);
               dbConfig.setProjectName(userConfig.getProjectName());
